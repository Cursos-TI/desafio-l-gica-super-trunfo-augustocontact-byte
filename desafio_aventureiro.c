...
int main() {
    ...
    // foi adicionado análise de dados com divisão
    float Densidade_Populacional;
    float PIB_per_Capita;

    // foi adicionado a fórmula de comparação tipo if, else if
...
//Área de cálculo de dados por divisão entre população / area(km)
    Densidade_Populacional= (populacao1) / (area1) ;
    printf("A densidade populacional é: %.5f\n", Densidade_Populacional);

// Área de cálculo de dados por divisão entre PIB / população
...
// Área de cálculo de dados por divisão entre PIB / população
    ...
    // Área para exibição dos dados das cidade
    ...
    // Área de cálculo usando if e else if para dencidade e PIB
    if (Densidade_Populacional > Densidade_Populacional2)
    {
        printf("Carta 2 venceu por densidade\n");
